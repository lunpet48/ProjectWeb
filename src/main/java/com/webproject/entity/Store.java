...
public class Store {
	...
	public Store(Long _id, @Size(max = 100) String name, @Size(max = 1000) String bio, String slug, User ownerId,
			List<User> staffIds, Boolean isActive, Boolean isOpen, String avatar, String cover, String[] featuredImages,
			Commission commissionId, int point, int[] rating, double eWallet, Date createdAt, Date updatedAt) {
		super();
		this._id = _id;
		this.name = name;
		this.bio = bio;
	...
	public void setStaffIds(List<User> staffIds) {
		this.staffIds = staffIds;
	}
