	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item active"><a class="nav-link"
				href="vendor/store"> <i class="fas fa-fw fa-tachometer-alt"></i>
			...
			<li class="nav-item active"><a class="nav-link"
				href="vendor/store/product"> <i
					class="fas fa-fw fa-tachometer-alt"></i> <span>Product</span></a></li>

			<li class="nav-item active"><a class="nav-link"
				href="vendor/store/orders"> <i
					class="fas fa-fw fa-tachometer-alt"></i> <span>Orders</span></a></li>
